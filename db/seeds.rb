...
CollateralsTag.create({tag_id: tag_1['id'], collateral_id: collateral_1['id'], weight: 2})
CollateralsTag.create({tag_id: tag_2['id'], collateral_id: collateral_1['id'], weight: 1})
CollateralsTag.create({tag_id: tag_2['id'], collateral_id: collateral_2['id'], weight: 2})
CollateralsTag.create({tag_id: tag_5['id'], collateral_id: collateral_3['id'], weight: 3})
CollateralsTag.create({tag_id: tag_2['id'], collateral_id: collateral_3['id'], weight: 1})
CollateralsTag.create({tag_id: tag_3['id'], collateral_id: collateral_3['id'], weight: 1})
CollateralsTag.create({tag_id: tag_5['id'], collateral_id: collateral_4['id'], weight: 2})
CollateralsTag.create({tag_id: tag_3['id'], collateral_id: collateral_5['id'], weight: 4})
CollateralsTag.create({tag_id: tag_4['id'], collateral_id: collateral_6['id'], weight: 2})
CollateralsTag.create({tag_id: tag_5['id'], collateral_id: collateral_6['id'], weight: 1})


lead_1 = Lead.create(name: 'New Lead')
LeadsTag.create({tag_id: tag_1['id'], lead_id: lead_1['id']})
